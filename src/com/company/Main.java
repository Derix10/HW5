...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        private static Hero[] createHeroes() {
            ...
            String[] hero = {"shinigami", "wolverine", "ironMan"};
            ...
            for (int i = 0; i < myheroes.length; i++) {
                System.out.println("Герой "+ Arrays.toString(new String[]{hero[i]}) +", Здоровье героя: "
                        + Arrays.toString(new int[]{myheroes1[i]}) + ", Урон героя: " + Arrays.toString
                        (new int[]{myheroes2[i]})
